            ...
            <table class="layui-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2017年7月09日16时00分00秒</td>
                        <td class="td-manage">
                            <a title="查看" href="javascript:;" onclick="person_look('查看','sjtj_person_look.html','4','','510')"
