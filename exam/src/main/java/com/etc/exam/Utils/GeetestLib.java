...
public class GeetestLib {
	 ...
	 * 公钥
	 */
	private String captchaId = "3d5faf543b748b7f16a41a5e375cfd74";

	/**
	 * 私钥
	 */
	private String privateKey = "684737a3a0e53eb17cca261e34195d14";
	...
	public int enhencedValidateRequest(String challenge, String validate, String seccode, HashMap<String, String> data) {	
		...
		try {
			...
			JSONObject return_map = JSONObject.fromObject(response);
